                    ...
                    */  
                    ...
                    if(!empty($companyAssignorAndAssigneeIDs)) {
                        ...
                        $queryUnderpaid = "
                            ...
                            INNER JOIN db_patent_maintainence_fee.event_maintainence_fees AS mf 
                                ON mf.appno_doc_num = CONVERT(base.application USING latin1) COLLATE latin1_swedish_ci
                            ...
                            WHERE mf.event_code IN ('F273', 'F274', 'F275', 'M2551', 'M2552', 'M2553', 'M2273', 'M2274', 'M2275', 'M2283', 'M2284', 'M2285') 
                            AND mf.event_date IS NOT NULL 
                            AND purchase.exec_dt IS NOT NULL
                        ...
                        if($resultUnderpaid && $resultUnderpaid->num_rows > 0) {
                            $underpaidCount = $resultUnderpaid->num_rows;
