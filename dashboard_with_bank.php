	...
	if((int)$company > 0) {	
        ...
        $companyAddress = array();  
            ...
            $abandonedStatus = array(
                ...
                /**
                 * Security transaction Assets
                 */
                $getSecurityAssets = "SELECT appno_doc_num FROM ".$dbUSPTO.".documentid where rf_id IN (SELECT rf_id FROM ".$dbUSPTO.".bank_security_transactions WHERE representative_id = ".$companyID.") GROUP BY appno_doc_num";
                $resultCompanyRepresentative = $con->query($getSecurityAssets);	
                $allSecurityAssets = array();
                if($resultCompanyRepresentative) {
                    while($assetRow = $resultCompanyRepresentative->fetch_object()) {
                ...
                $getReleaseAssets = "SELECT appno_doc_num FROM ".$dbUSPTO.".documentid where rf_id IN (SELECT rf_id FROM ".$dbUSPTO.".bank_release_transactions WHERE representative_id = ".$companyID.") GROUP BY appno_doc_num";
                ...
                if(count($allSecurityAssets) > 0 && count($allReleasedAssets) > 0 ) {
                    $allSecurityAssets = array_diff($allSecurityAssets, $allReleasedAssets); 
                }
 
                
                $companyAllAssignorAndAssigneeIDs = array();
                $listAllAssets = array();
                $queryFindCompanyRepresentative = "SELECT representative_id, representative_name FROM ".$dbUSPTO.".representative WHERE  representative_id = ".$companyID." ORDER BY representative_id DESC LIMIT 1";
                echo $queryFindCompanyRepresentative;
                $resultCompanyRepresentative = $con->query($queryFindCompanyRepresentative);	
                $representativeID = 0; $representativeRow = array();
                ...
                $allCompanyNames = array();$companyAssignorAndAssigneeIDs = array();

                $queryAssignorAndAssigneeIDs = "SELECT assignor_and_assignee_id, name FROM ".$dbUSPTO.".assignor_and_assignee WHERE representative_id = ".$representativeID." GROUP BY assignor_and_assignee_id "; 
                ...
                $queryApplicant = "SELECT assignor_and_assignee_id FROM db_patent_application_bibliographic.assignor_and_assignee WHERE name = '".$con->real_escape_string($representativeRow->representative_name)."'   OR representative_id = ".$representativeID." GROUP BY assignor_and_assignee_id";
                ...
                if(count($applicantAssignorAndAssigneeIDs) > 0) {
                    $queryApplicantAssets = "SELECT * FROM (SELECT appno_doc_num FROM ( SELECT appno_doc_num  FROM db_patent_grant_bibliographic.applicant 
                    ...
                    UNION 
                    SELECT appno_doc_num FROM ".$dbUSPTO.".table_b  WHERE company_id = ".$companyID." AND appno_doc_num IN (SELECT appno_doc_num FROM ".$dbUSPTO.".documentid WHERE rf_id IN (SELECT rf_id FROM ".$dbApplication.".activity_parties_transactions WHERE company_id = ".$companyID." AND activity_id IN ( 10 ) AND recorded_assignor_and_assignee_id IN (".implode(',', $companyAssignorAndAssigneeIDs).")) GROUP BY appno_doc_num) GROUP BY appno_doc_num) AS temp WHERE appno_doc_num IN (".implode(',', $allSecurityAssets).") ";
                 ...
                 */
                $queryAllAssetsList = "SELECT * FROM ( SELECT appno_doc_num FROM ".$dbUSPTO.".table_b  WHERE company_id = ".$companyID." AND appno_doc_num IN (SELECT appno_doc_num FROM ".$dbUSPTO.".documentid WHERE rf_id IN (SELECT rf_id FROM ".$dbApplication.".activity_parties_transactions WHERE company_id = ".$companyID." AND activity_id IN ( 1, 6 ) AND recorded_assignor_and_assignee_id IN (".implode(',', $companyAssignorAndAssigneeIDs).") ) GROUP BY appno_doc_num)  GROUP BY appno_doc_num) AS temp WHERE appno_doc_num IN (".implode(',', $allSecurityAssets).")";
               ...
               $queryAllAssetsList = "SELECT * FROM ( SELECT appno_doc_num FROM ".$dbUSPTO.".table_b  WHERE company_id = ".$companyID." AND appno_doc_num IN (SELECT appno_doc_num FROM ".$dbUSPTO.".documentid WHERE rf_id IN (SELECT rf_id FROM ".$dbApplication.".activity_parties_transactions WHERE company_id = ".$companyID." AND recorded_assignor_and_assignee_id IN (".implode(',', $companyAssignorAndAssigneeIDs).") ) GROUP BY appno_doc_num) GROUP BY appno_doc_num ) AS temp WHERE appno_doc_num IN (".implode(',', $allSecurityAssets).")";
                ...
                $querySoldAssetsList = "SELECT * FROM ( SELECT appno_doc_num FROM ".$dbUSPTO.".documentid WHERE rf_id IN (SELECT rf_id FROM ".$dbApplication.".activity_parties_transactions WHERE company_id = ".$companyID." AND activity_id IN ( 2, 7 ) ) GROUP BY appno_doc_num) AS temp WHERE appno_doc_num IN (".implode(',', $allSecurityAssets).")";
                ...
                */
                ...
                $deleteQuery = "DELETE FROM ".$dbApplication.".dashboard_items WHERE mode = 1 AND type IN (".implode(',', $allTypes).") AND representative_id = ".$companyID;

                $con->query($deleteQuery);

                $deleteQuery = "DELETE FROM ".$dbApplication.".dashboard_items_count WHERE mode = 1 AND type IN (".implode(',', $allTypes).") AND representative_id = ".$companyID;
                ...
                if(count($originalList) > 0  || count($expiredAssets) > 0 || count($soldAssets) > 0 || count($applicantAssets) > 0 ) {  
                    ...
                    */
                    ...
                    $queryOwnedPatent = "INSERT IGNORE INTO ".$dbApplication.".dashboard_items (mode, representative_id, assignor_id, type, patent, application, rf_id, total) SELECT  1, ".$companyID.", 0, ".$type.", patent, application, 0, 0 FROM ".$dbApplication.".dashboard_items  WHERE mode = 1 AND type IN (31, 32) AND representative_id = ".$companyID." GROUP BY application";

                    $con->query($queryOwnedPatent);


                    if(count($listAllAssets) > 0) {
                        $con->query("INSERT IGNORE INTO ".$dbApplication.".owned_assets(appno_doc_num, company_id) SELECT application, ".$companyID." FROM ".$dbApplication.".dashboard_items WHERE mode = 1 AND representative_id = ".$companyID." AND type = 30 GROUP BY application");
                    }
                    ...
                    $clientOwnedQuery = "SELECT application FROM db_new_application.dashboard_items WHERE mode = 1 AND representative_id = ".$companyID." AND type = 30 GROUP BY application";
                    ...
                    $seQuery = "SELECT tempSecurity.appno_doc_num FROM (SELECT appNo AS appno_doc_num, eeName, count(rf_id) AS counter, 'security' as type FROM (
                        ...
                        WHERE rac.convey_ty IN ('security', 'restatedsecurity') AND appno_doc_num IN (".implode(',', $clientOwnedAssets).")) AS temp GROUP BY appNo, eeName HAVING counter > 0 ) as tempSecurity 
                        LEFT JOIN (
                            SELECT appNo AS appno_doc_num, eeName, count(rf_id) AS counter FROM (
                                ...
                                LEFT JOIN representative AS r ON r.representative_id = aaa.representative_id
                                WHERE rac.convey_ty IN ('release', 'partialrelease') AND appno_doc_num IN (".implode(',', $clientOwnedAssets).")
                            ) AS temp
                    ...
                    if(count($clientOwnedAssets) > 0) {
                        ...
                        where mode = 1 AND representative_id = ".$companyID." AND type = ".$type.")";
                    ...
                    WHERE inv.appno_doc_num IN (".implode(',', $originalApplicantAssets).") AND inv.appno_doc_num NOT IN (SELECT application FROM ".$dbApplication.".dashboard_items WHERE mode = 1 AND representative_id = ".$companyID." AND type = ".$type." GROUP BY application) GROUP BY aaa.name, ap.appno_doc_num ";
                    ...
                    $queryLawFirms = "INSERT IGNORE INTO ".$dbApplication.".dashboard_items (mode, representative_id, assignor_id, type, patent, application, rf_id, total, lawfirm, lawfirm_id) SELECT 1, ".$companyID.", 0, ".$type.", patent, application, rf_id, 0,
                    ...
                    $type = 41;
                    $queryLenders = "INSERT IGNORE INTO ".$dbApplication.".dashboard_items (mode, representative_id, assignor_id, type, patent, application, rf_id, total) SELECT 1, ".$companyID.", apt.assignor_and_assignee_id, ".$type.", d.grant_doc_num,  d.appno_doc_num, apt.rf_id, 0 FROM ".$dbUSPTO.".documentid AS d 
                            ...
                            AND d.appno_doc_num IN (".implode(',', $allSecurityAssets).") AND date_format(d.appno_date, '%Y') > ".$YEAR."  AND apt.activity_id IN (5, 12) AND apt.company_id = ".$companyID."
                            GROUP BY apt.rf_id, apt.assignor_and_assignee_id";
echo "LeNNNNNNNNDDDDDDDEEEEERRRRRRRR";
echo $queryLenders;
                    ...
                    $con->query("DELETE FROM db_new_application.dashboard_items WHERE mode = 1 AND type = 1 AND representative_id = ".$companyID);
                     ...
                     */
                    $type = 17;
                    $queryIncorrectNames = "INSERT IGNORE INTO ".$dbApplication.".dashboard_items (mode, representative_id, assignor_id, type, patent, application, rf_id, total) SELECT 1, ".$companyID." AS representative_id, recorded_assignor_and_assignee_id AS assignor_id, ".$type." AS type, grantNo, appno, rf_id, ".count($clientOwnedAssets)." AS total FROM (
                    ...
                    */   
                    ...
                    $queryDivest =  "INSERT IGNORE INTO ".$dbApplication.".dashboard_items (mode, representative_id, assignor_id, type, patent, application, rf_id, total) SELECT 1, ".$companyID." AS representative_id, 0 AS assignor_id, ".$type.",  patent, application, '' AS rf_id, ".count($clientOwnedAssets)." FROM ".$dbApplication.".dashboard_items WHERE representative_id = ".$companyID." and type = 30 
                    and mode = 0 AND application NOT IN (SELECT application FROM ".$dbApplication.".dashboard_items WHERE representative_id = ".$companyID." and type = 30 
                    and mode = 1) ";
                    ...
                    if(count($applicantAssets) > 0) {
                        $type = 22;
                        $queryApplicantAssets = "SELECT application, patent FROM ".$dbApplication.".dashboard_items WHERE mode = 1 AND type = 31 AND representative_id = ".$companyID." GROUP BY application";
                        ...
                        if($resultApplicant && $resultApplicant->num_rows > 0) { 
                            ...
                            if(count($remainingApplicantAssets) > 0) {
                                ...
                                if(count($remainingApplicantAssets) > 0) {
                                    $queryUnAssignedAssets = "INSERT IGNORE INTO ".$dbApplication.".dashboard_items (mode, representative_id, assignor_id, type, patent, application, rf_id, total) SELECT 1, ".$companyID." AS representative_id, assignor_id, ".$type.",  patent, application,  rf_id, ".count($applicantAssets)."  FROM (SELECT * FROM ".$dbApplication.".dashboard_items  WHERE mode = 1 AND type = 31 AND representative_id = ".$companyID." AND application IN  (".implode(',', $remainingApplicantAssets).") GROUP BY application) AS temp";
                                    ...
                                    */
                                     ...
                                     $queryToRecordFromDelete = "DELETE FROM ".$dbApplication.".dashboard_items WHERE mode = 1 AND type = 1 AND representative_id = ".$companyID." AND application IN (SELECT * FROM ( SELECT application FROM ".$dbApplication.".dashboard_items WHERE mode = 1 AND type = ".$type." AND representative_id = ".$companyID." ) AS temp )";
                    ...
                    $clientOwnedQuery = "SELECT patent FROM db_new_application.dashboard_items WHERE mode = 1 AND representative_id = ".$companyID." AND type = 30 AND patent <> '' GROUP BY patent";
                    ...
                    $divestedCounter = "SELECT patent FROM ".$dbApplication.".dashboard_items AS di WHERE mode = 1 AND di.type = 21 AND patent <> '' AND representative_id = ".$companyID." GROUP BY patent";
                    ...
                    if(count($citationAssets) > 0) {
                        ...
                        $queryMonetized = "INSERT IGNORE INTO ".$dbApplication.".dashboard_items (mode, representative_id, assignor_id, type, patent, application,   total) SELECT 1, ".$companyID." AS representative_id, 0 AS assignor_id, ".$type.", grant_doc_num, appno_doc_num,  ".$countQuery."  FROM ( SELECT grant_doc_num, appno_doc_num FROM db_patent_application_bibliographic.application_grant WHERE grant_doc_num IN  (".implode(',', $citationAssets).") AND  date_format(appno_date, '%Y') <= ".$pastYear12." ) AS temp GROUP BY appno_doc_num";
                        $con->query($queryMonetized);
                    ...
                    */
                    $type = 23;
                    $queryLateMaintainence = "INSERT IGNORE INTO ".$dbApplication.".dashboard_items (mode, representative_id, assignor_id, type, patent, application, rf_id, total) SELECT 1, ".$companyID." AS representative_id, 0 AS assignor_id, ".$type.", emf.grant_doc_num, tawb.appno_doc_num, '' AS rf_id, ".count($clientOwnedAssets)."                               
                    ...
                    */  
                    ...
                    foreach($allTypes as $type) {
                        if($type == 35) {   
                            ...
                            $queryInsertMaintainence = "INSERT IGNORE INTO ".$dbApplication.".dashboard_items_count (mode, number, representative_id, assignor_id, type,  total) SELECT 1, SUM(total) AS number,  ".$companyID." AS representative_id, 0, ".$type.", COUNT(IF(patent <> '', patent, null)) AS total FROM ".$dbApplication.".dashboard_items WHERE  mode = 1 AND representative_id = ".$companyID." AND type = ".$type;
                            ...
                            $queryInsertFamily = "INSERT IGNORE INTO ".$dbApplication.".dashboard_items_count (mode, number, representative_id, assignor_id, type,  total, other) VALUES ( 1, 0, ".$companyID.", 0, ".$type.", 0, '".json_encode($patentFamily)."')";
                            ...
                            $queryInventor = "SELECT name, COUNT(application) AS number FROM ".$dbApplication.".dashboard_items WHERE mode = 1 AND representative_id = ".$companyID." AND type = ".$type." GROUP BY name ORDER BY number DESC, name ASC LIMIT 20"; 
                            ...
                            $queryInsertParties = "INSERT IGNORE INTO ".$dbApplication.".dashboard_items_count (mode, number, representative_id, assignor_id, type,  total, other) VALUES (1, 0, ".$companyID.", 0, ".$type.", 0, '".json_encode($allInventor)."')";
                            ...
                            $queryInsertParties = "INSERT IGNORE INTO ".$dbApplication.".dashboard_items_count (mode, number, representative_id, assignor_id, type,  total, other) VALUES (1, 0, ".$companyID.", 0, ".$type.", 0, '".json_encode($parties)."')";
                             ...
                             * LawFirm
                             */
                            $queryLawFirm = "SELECT lawfirm AS name, COUNT(rf_id) AS number FROM ".$dbApplication.".dashboard_items WHERE mode = 1 AND representative_id = ".$companyID." AND type = ".$type." GROUP BY lawfirm ORDER BY number DESC, name ASC  LIMIT 20"; 
                            ...
                            $queryInsertLawFirms = "INSERT IGNORE INTO ".$dbApplication.".dashboard_items_count (mode, number, representative_id, assignor_id, type,  total, other) VALUES ( 1, 0, ".$companyID.", 0, ".$type.", 0, '".json_encode($allLawfirms)."')";
                            
                            $con->query($queryInsertLawFirms); 
                            
                        } else if ($type < 28 && $type != 20) {
                            $queryInsertCounter = "INSERT IGNORE INTO ".$dbApplication.".dashboard_items_count (mode, number, other_number,  total, representative_id, assignor_id, type) SELECT 1, SUM(number + other_number) AS num, 0, total,  representative_id, assignor_id, type FROM (SELECT COUNT(IF(patent <> '', patent, null)) AS number, COUNT(IF(patent = '', application, null)) AS other_number,  total, ".$companyID." AS representative_id, 0 AS assignor_id, ".$type." AS type FROM ( SELECT * FROM ".$dbApplication.".dashboard_items WHERE mode = 1 AND representative_id = ".$companyID." AND type = ".$type." GROUP BY application ) AS temp2 ) AS temp";
                            
                            $con->query($queryInsertCounter);  
                        }  else if($type == 34) {
                            $queryInsertCounter = "INSERT IGNORE INTO ".$dbApplication.".dashboard_items_count (mode, number, other_number,  total, representative_id, assignor_id, type) SELECT 1, COUNT(IF(patent <> '', patent, null)) AS number, COUNT(IF(patent = '', application, null)) AS other_number,  total,  ".$companyID." AS representative_id, 0, ".$type." FROM ( SELECT application, patent, total FROM ".$dbApplication.".dashboard_items WHERE mode = 1 AND representative_id = ".$companyID." AND type = ".$type." GROUP BY application ) AS temp";
